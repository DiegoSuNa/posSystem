...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <section class="sidebar"> <!-- Al parecer el no usar el sectio 
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="src/view/img/usuarios/default/anonymous.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Pedrozcok2009_</a>
        </div>
      </div>
